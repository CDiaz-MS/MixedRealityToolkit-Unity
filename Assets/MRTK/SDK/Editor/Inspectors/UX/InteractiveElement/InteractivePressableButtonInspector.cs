...
namespace Microsoft.MixedReality.Toolkit.Editor
{
    ...
    /// </summary>
    [CustomEditor(typeof(InteractivePressableButton))]
    [CanEditMultipleObjects]
    public class InteractivePressableButtonInspector : InteractiveButtonInspector
    {
        ...
        private InteractivePressableButton button;
        ...
        protected override void OnEnable()
        {
            ...
            button = (InteractivePressableButton)target;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (EditorGUI.EndChangeCheck() && currentMode != distanceSpaceMode.intValue)
            {
                ...
                button.DistanceSpaceMode = (InteractivePressableButton.SpaceMode)distanceSpaceMode.enumValueIndex;
                serializedObject.Update();
            }
